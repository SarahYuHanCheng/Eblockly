...
StandardCategories.categoryMap['myvar'] =
    new ListElement(ListElement.TYPE_CATEGORY, 'myvar');
StandardCategories.categoryMap['myvar'].xml =
    Blockly.Xml.textToDom(
    '<xml>' +
    '<block type="my_one"></block>' +
	'<block type="my_four"></block>' +
    '</xml>');
StandardCategories.categoryMap['myvar'].color ='#5C81A6';
...
StandardCategories.coreBlockTypes =  ["my_four", "controls_if", "logic_compare",
